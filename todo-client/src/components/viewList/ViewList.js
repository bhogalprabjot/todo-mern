        ...
        isLoading ? <LoadingSpinner /> :
            <div className='ViewList'>
                <div className='taskList-top-btns'>
                    <a href='/home' className='backBtn' onClick={save}><MdKeyboardBackspace color='rgba(146,20,230)' /></a>
                ...
                <div className='title'>
                    {/* <div className='titleText'>{list.title}</div> */}
                    {
                        !isTitleSet ?
                            <>
                                <input type="text" className='titleTextInput' placeholder='Title' value={list.title} name='title' onChange={handleChange} />
